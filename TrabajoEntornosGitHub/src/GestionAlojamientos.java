...
public class GestionAlojamientos {
	...
	/**
	 * Método principal que gestiona los alojamientos.
	 * @param args
	 */
	...
	/**
	 * Este método te permitirá crear los diferentes tipos de alojamientos.
	 * @param alojamientos. Este parámetro implementa la colección de los alojamientos.
	 */
	...
	/**
	 * Este método muestra los alojamientos introducidos en la colección.
	 * @param alojamientos. Este parámetro implementa la colección de los alojamientos.
	 */
	...
	/**
	 * Este método te pemitirá dar de alta los diferentes tipos de alojamientos.
	 * @param alojamientos. Este parámetro implementa la colección de los alojamientos.
	 * @param alojamiento. Este parámetro recibe el valor del alojamiento para darlo de alta.
	 */
	...
	/**
	 * Este método busca en la colección dependiendo del código de alojamiento.
	 * @param alojamientos. Este parámetro implementa la colección de los alojamientos.
	 * @param alojamiento. Este parámetro recibe el valor del alojamiento a buscar.
	 * @return. Devuelve la posición en la colección del alojamiento y si no se encuentra, devuelve -1 y finaliza.
	 */
	...
	/**
	 * Este método te permitirá calcular el precio del alquiler de los diferentes alojamientos de la colección.
	 * @param alojamientos. Este parámetro implementa la colección de los alojamientos.
	 */
	...
	/**
	 * Este método te permitirá mostrar el precio del alquiler de los diferentes alojamientos de la colección.
	 * @param alojamientos. Este parámetro implementa la colección de los alojamientos.
	 */
